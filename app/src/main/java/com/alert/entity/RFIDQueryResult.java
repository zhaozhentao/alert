...
public class RFIDQueryResult {
     ...
     * remark : 备注
     * fullVehsImgPath : http://ss/ 2016/8/83a41c.jpg
     * vehsBrand : 台力
     ...
     * price : 2700
     * fullIdCardImgPath :  http://ss/ 2016/8/83a41c.jpg
     */
    ...
    public int price;
    public String fullIdCardImgPath;
    public String rfidRegistrant;
    public String rfidRegistDepartment;
    public String rfidStatus;

    @Override
    public String toString() {
        return "RFIDQueryResult{" +
            "id='" + id + '\'' +
            ...
            ", remark='" + remark + '\'' +
            ", fullVehsImgPath='" + fullVehsImgPath + '\'' +
            ", vehsBrand='" + vehsBrand + '\'' +
            ...
            ", price=" + price +
            ", fullIdCardImgPath='" + fullIdCardImgPath + '\'' +
            '}';
    }
}
